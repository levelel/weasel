rem Try to set up the Visual Studio developer environment.
...
if not defined BOOST_ROOT set BOOST_ROOT=C:\local\boost_1_78_0
...
set DEVTOOLS_PATH=%ProgramFiles%\Git\usr\bin;%ProgramFiles%\Git\cmd;%ProgramFiles%\CMake\bin;